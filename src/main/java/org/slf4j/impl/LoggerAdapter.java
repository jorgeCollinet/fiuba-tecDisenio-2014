...
public final class LoggerAdapter implements Logger {
	...
	public void debug(Marker arg0, String arg1, Object arg2) {
		Log.log(Level.debug, arg0.getName() + ":" + arg1 + ":" + arg2,
				nombreLogger);
	}

	@Override
	public void debug(Marker arg0, String arg1, Object... arg2) {
		Log.log(Level.debug, arg0.getName() + ":" + arg1 + ":"
				+ objArrayToString(arg2), nombreLogger);
	}
	...
	public void error(Marker arg0, String arg1, Object arg2) {
		Log.log(Level.error, arg0.getName() + ":" + arg1 + ":" + arg2,
				nombreLogger);
	}

	@Override
	public void error(Marker arg0, String arg1, Object... arg2) {
		Log.log(Level.error, arg0.getName() + ":" + arg1 + ":"
				+ objArrayToString(arg2), nombreLogger);
	}
	...
	public void info(Marker arg0, String arg1, Object arg2) {
		Log.log(Level.info, arg0.getName() + ":" + arg1 + ":" + arg2,
				nombreLogger);
	}

	@Override
	public void info(Marker arg0, String arg1, Object... arg2) {
		Log.log(Level.info, arg0.getName() + ":" + arg1 + ":"
				+ objArrayToString(arg2), nombreLogger);
	}
	...
	public void trace(Marker arg0, String arg1, Object arg2) {
		Log.log(Level.trace, arg0.getName() + ":" + arg1 + ":" + arg2,
				nombreLogger);
	}

	@Override
	public void trace(Marker arg0, String arg1, Object... arg2) {
		Log.log(Level.trace, arg0.getName() + ":" + arg1 + ":"
				+ objArrayToString(arg2), nombreLogger);
	}
	...
	public void warn(Marker arg0, String arg1, Object arg2) {
		Log.log(Level.warning, arg0.getName() + ":" + arg1 + ":" + arg2,
				nombreLogger);
	}

	@Override
	public void warn(Marker arg0, String arg1, Object... arg2) {
		Log.log(Level.warning, arg0.getName() + ":" + arg1 + ":"
				+ objArrayToString(arg2), nombreLogger);
	}
