...
public class OutputCustom implements IOutput {
	...
	public static OutputCustom generateOutputCustom(String className)
			throws Exception {
		...
		throw new Exception("nombre de clase: " + className
				+ " no implementa interfaz IOutput\n");
	}
		...
		try {
			try {
				...
				try {
					...
					e.printStackTrace();
					System.out
							.println("Error de programación al intentar instanciar un OutputCustom.");
				}
